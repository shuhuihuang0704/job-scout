...
1. Employer career page or the employer's own public recruiting post.
2. Original post by an identified recruiter or hiring manager, when the post clearly names the employer and role.
3. Public job board listing that appears to be the source of the posting.
4. Aggregator pages, only as leads to locate an original source.
